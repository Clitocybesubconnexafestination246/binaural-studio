...
The same preflight pass estimates BPM, pulse confidence, and beat phase. On confidently analysed tracks, Phase reserves its sharp, high-crest spatial impulses for sustained quiet passages detected in the whole-track waveform. Even there the layer visits intermittently rather than carpeting the song. Low-confidence or rhythmically ambiguous material falls back to continuous filtered “air”. Automatic crossfades create a short centre pocket by dipping both songs, lifting the air bed, and concentrating a burst of impulses between them. **Texture** controls the whole layer, and impulse and spatial behaviour can be disabled independently.
