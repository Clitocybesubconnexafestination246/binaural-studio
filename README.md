...
The same preflight pass estimates BPM, pulse confidence, and beat phase. Clear rhythmic material gets sparse, four-beat impulse-noise punctuation; low-confidence or rhythmically ambiguous material falls back to continuous filtered “air” rather than inventing an awkward beat. The texture favours genuine quiet space and adds a longer spatial sweep across automatic crossfades. **Texture** controls the whole layer, and impulse and spatial behaviour can be disabled independently.
